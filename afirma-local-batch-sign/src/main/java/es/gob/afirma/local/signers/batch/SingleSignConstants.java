...
import es.gob.afirma.local.triphase.signer.processors.CAdESTriPhasePreProcessor;
import es.gob.afirma.local.triphase.signer.processors.FacturaETriPhasePreProcessor;
import es.gob.afirma.local.triphase.signer.processors.PAdESTriPhasePreProcessor;
import es.gob.afirma.local.triphase.signer.processors.TriPhasePreProcessor;
import es.gob.afirma.local.triphase.signer.processors.XAdESTriPhasePreProcessor;
...
public final class SingleSignConstants {
	...
	static TriPhasePreProcessor getTriPhasePreProcessor(final SingleSign sSign) throws AOInvalidFormatException {
		...
		switch(sSign.getSignFormat()) {
			...
			case XADES:
				return new XAdESTriPhasePreProcessor(false);
			case FACTURAE:
				return new FacturaETriPhasePreProcessor(false);
			default:
